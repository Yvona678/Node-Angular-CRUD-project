...
export class AppComponent implements OnInit {
  ...
  public onCreateItem(newItemName: string): void {
    this.todoService.createItem({todo: newItemName}).subscribe((response: any) => {
      this.items.push({name: newItemName, id: response.id});
       // cand requestul a fost facut cu succes si am primit raspunsul, push-uim itemul in lista impreuna cu id-ul din raspuns
  ...
  public onUpdateItem(newItem: any): void {
    this.todoService.updateItem(newItem).subscribe((response: any) => {
